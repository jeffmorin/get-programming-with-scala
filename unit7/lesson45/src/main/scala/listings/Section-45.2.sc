...
// res0: scala.concurrent.Future[Option[Int]] = Future(<not completed>)

seqAB
// res1: scala.concurrent.Future[Option[Int]] = Future(Success(Some(42)))

Future.find(Seq(futureA, futureB))(_ > 100)
// res2: scala.concurrent.Future[Option[Int]] = Future(Success(None))
...
seqAC
// res2: scala.concurrent.Future[Seq[Int]] = Future(Success(List(42, 123)))
