// In Scala 2 2: def pow(exp: Int)(implicit base: Int): Double = …
def pow(exp: Int)(using base: Int): Double = Math.pow(base, exp)

// In Scala 2 2: implicit val a: Int = …
...
object Base {
  ...
  // In Scala 2 2: implicit val b: Int = 2
  given b: Int = 2
}

// In Scala 2 2: import Base._
...
object Test {
  ...
  // implicit selected 
  // In Scala 2 2: implicit val name: Name[Test] = new Name[Test] {…}
